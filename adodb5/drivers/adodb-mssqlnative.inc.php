...
class ADODB_mssqlnative extends ADOConnection {
	...
	*/
	...
	/**
	 * Originally, this class used the parent's MetaColumns method (ADOConnection::MetaColumns)
	 * In order to add the capability to recognize identity columns, I've copied here the parent method,
	 * and updated "var $metaColumnsSQL" at line 114 in order to give out also this field
	 */
